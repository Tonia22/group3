...
<body>
    <div class="all" style="background-image: url('./project/1660581698595.jpg'); background-size:cover; background-position:center;">
        <div class="ha" style="background: rgb(0,0,0,0.6); height:100vh; width:100%;">
            ...
            <div class="body" style="height: 70vh;">
                <div class="text">
                    ...
                    <h6 id="ti" style="color: whitesmoke; line-height:30px;">Just confirm your order and enjoy our special delicacies, <br>will be swiftly delivered to your doorstep . </h6>
                    <br>
                    <button id="ni" class="order">Order Now</button>
                    <br>
                    <br>
                    <div class="flow">
    ...
    <script>
        ...
        //     const passEl = document.getElementById("this");
        //     const work = pics[Math.floor(Math.random() * pics.length)];
        //     passEl.style.content = work;
        // }
